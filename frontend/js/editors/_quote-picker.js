...
(function () {
  ...
  function buildShell() {
    const html = [
      ...
      '<label class="search-box quote-picker-search">',
      '<span class="search-box__icon" aria-hidden="true">⌕</span>',
      '<input class="js-quote-search" type="search" placeholder="Qidirish — matn yoki muallif…" autocomplete="off" aria-label="Search quotes" />',
      '<button type="button" class="search-box__clear" data-search-clear aria-label="Clear search" tabindex="-1">×</button>',
      "</label>",
